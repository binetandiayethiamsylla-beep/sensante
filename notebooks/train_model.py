...
patients_test = [
    {'age': 10, 'sexe': 'M', 'temperature': 36.5, 'tension_sys': 11, 'toux': False, 'fatigue': False, 'maux_tete': False, 'region': 'Dakar'},
    {'age': 35, 'sexe': 'F', 'temperature': 40.5, 'tension_sys': 9, 'toux': True, 'fatigue': True, 'maux_tete': True, 'region': 'Thiès'},
    {'age': 70, 'sexe': 'M', 'temperature': 38.5, 'tension_sys': 14, 'toux': True, 'fatigue': True, 'maux_tete': False, 'region': 'Saint-Louis'},
]

descriptions = ["Jeune sans symptomes", "Adulte avec forte fievre", "Patient age avec toux"]
...
for i, patient in enumerate(patients_test):
    ...
    print(f"\nPatient {i+1} ({descriptions[i]}) : {diagnostic} ({proba:.1%})") 